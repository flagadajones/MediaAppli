...
public class UpnpDevice {
	...
	static public String FIND_RENDERER = "fr.flagadajones.MediaController.upnp.UpnpDevice.FIND_RENDERER";
	static public String FIND_SERVER = "fr.flagadajones.MediaController.upnp.UpnpDevice.FIND_SERVER";
	...
	private void setIcone() {
		...
		if (device.isFullyHydrated()) {
			...
			if (device.getIcons().length != 0) {
				icone = ((RemoteDevice) device).normalizeURI(
