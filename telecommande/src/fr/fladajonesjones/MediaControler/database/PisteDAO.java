...
public class PisteDAO {
    ...
    public Piste getPiste(int id) {
        Cursor c = maBaseDonnees.query(MySQLOpenHelper.TABLE_PISTES, new String[] { MySQLOpenHelper.COLONNE_PISTE_ID, MySQLOpenHelper.COLONNE_PISTE_NOM,
                MySQLOpenHelper.COLONNE_PISTE_DUREE, MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID,
                MySQLOpenHelper.COLONNE_PISTE_URL }, MySQLOpenHelper.COLONNE_PISTE_ID + " = " + id, null, null, null,
                null);
    ...
    public Piste getPiste(String nom) {
        Cursor c = maBaseDonnees.query(MySQLOpenHelper.TABLE_PISTES, new String[] { MySQLOpenHelper.COLONNE_PISTE_ID, MySQLOpenHelper.COLONNE_PISTE_NOM,
                MySQLOpenHelper.COLONNE_PISTE_DUREE, MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID,
                MySQLOpenHelper.COLONNE_PISTE_URL }, MySQLOpenHelper.COLONNE_PISTE_NOM + " LIKE \""
    ...
    public ArrayList<Piste> getAllPistes() {
        Cursor c = maBaseDonnees.query(MySQLOpenHelper.TABLE_PISTES, new String[] { MySQLOpenHelper.COLONNE_PISTE_ID, MySQLOpenHelper.COLONNE_PISTE_NOM,
                MySQLOpenHelper.COLONNE_PISTE_DUREE, MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID,
                MySQLOpenHelper.COLONNE_PISTE_URL }, null, null, null, null, MySQLOpenHelper.COLONNE_PISTE_NOM);
    ...
    public ArrayList<Piste> getAllPistes(String album) {
        Cursor c = maBaseDonnees.query(MySQLOpenHelper.TABLE_PISTES, new String[] { MySQLOpenHelper.COLONNE_PISTE_ID, MySQLOpenHelper.COLONNE_PISTE_NOM,
                MySQLOpenHelper.COLONNE_PISTE_DUREE, MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID,
                MySQLOpenHelper.COLONNE_PISTE_URL }, MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID +" = \""+ album +"\"", null, null, null,null);
    ...
    private Piste cursorToPiste(Cursor c) {
        ...
        Piste retPiste = new Piste(c.getString(MySQLOpenHelper.COLONNE_PISTE_ID_ID),
                ...
                c.getString(MySQLOpenHelper.COLONNE_PISTE_ALBUM_ID_ID), c.getString(MySQLOpenHelper.COLONNE_PISTE_URL_ID));
    ...
    // public long insertPiste(ContentValues valeurs) {
    // return maBaseDonnees.insert(MySQLOpenHelper.TABLE_PISTES, null, valeurs);
    // }
