...
public class MediaRenderer {
    ...
    public MediaRenderer() {
        ...
        LocalService<MyConnectionManagerService> connectionManagerService = binder
                .read(MyConnectionManagerService.class);
        connectionManager = new DefaultServiceManager<MyConnectionManagerService>(connectionManagerService) {
            @Override
        ...
        renderingControl = new MyServiceManager<MyAudioRenderingControlService>(renderingControlService,
                lastChangeParserRendering) {
            @Override
        ...
        try {
            ...
            String uuid = preferences.getString(PREF_UUID, UUID.randomUUID().toString());
            preferences.edit().putString(PREF_UUID, uuid).commit();
